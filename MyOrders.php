                ...
                <tr>
                    ...
                    <li></li>
                        ...
                        <div id="right">
                            ...
                            if($query->num_rows==0)
                                echo '<h1 style="text-align:center;color:grey">No Orders have been placed</h1>';
                            else
                            ...
                            echo '<section><tr>
                                    <h2 style="color:grey;font-size:18px;">Order Date: '.$date->format('m-d-Y g:i a').'</h2>
                                    <h3 style="color:grey">Order #: '.$row['ordernumber'].'</h3>
                                    <h3 style=>Subject: '.$row['subject'].'<br>
                                        Course: '.$row['course'].'<br>
                                        Title: '.$row['title'].'<br>
                                        Condition: '.$row['conditions'].'<br>
                                        Price: $'.$row['price'].'<br>
                                </tr></section>';
				            }
                        ?>
