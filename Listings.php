...
VALUES ('', '$subject', '$course', '$title', '$price', '$condition','$description', '$file','$SESSIONID','')";
 ...
 <div>
            <table id="myTable">
            	...
            	Please Confirm that the Information Below is Correct </h1>
					...
					<input style= "display:inline-block; text-align:center" onClick="window.location.href='Buy'" type="button" class="button" value="Continue">
					</div>
				</div>
    </div>
</body>
