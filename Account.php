    ...
    <body>
        <div>
            <table id="myTable">
                ...
                <div id="right">
                    <div style="text-align:left;padding-right:75px;font-size:18px">  
                        <?php
                            session_start();
                            $servername = "localhost";
                            $dbusername = "root";
                            ...
                            $query = mysqli_query($conn, $sql);
                            $row  = mysqli_fetch_array($query);
                            echo '<h1 style="margin:0px;text-align:center">'.$row['fname'].','; ?> You have successfully logged in!<br></h1>
                            <p style=" text-align:center">You can manage your account, view your recent listings, and edit your password and account details.<br></p>
                    <center>
                        <object data="https://memegenerator.net/img/instances/37513632.jpg" style="text-align:center"></object>
                        </center><br>
